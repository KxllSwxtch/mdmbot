...
def get_currency_rates():
    ...
    # Получаем курс USDT/KRW через Naver Crypto API
    try:
        cookies = {
            "NAC": "2QfGCIBudkAvB",
            "NNB": "5VYPEL22ENFGQ",
            "SRT30": "1751858226",
            "_naver_usersession_": "LlvYq6jzmYDylXhi2LNnVg==",
            "SRT5": "1751860483",
            "page_uid": "jbWa0dqo1SossfQRU4Gssssss70-513913",
            "BUC": "pNuNOr91SZsKx1X4Yo6y_kN_nKkQ0nZ26_Blld-FL6g=",
        }
        ...
        if data and "result" in data and "USDT_KRW_UPBIT" in data["result"]:
            trade_price = data["result"]["USDT_KRW_UPBIT"]["tradePrice"]
            # Вычитаем 15 от курса
            krw = trade_price - 15
            ...
            print_message("Не удалось получить курс USDT/KRW из ответа API")
...
def handle_callback_query(call):
    ...
    # Обработка кнопки "Назад" при вводе стоимости
        ...
        detail_message = (
            ...
            f"🇰🇷 +82 10 7732 4808 <a href='https://wa.me/821077324808'>Менеджер</a>\n"
        )
